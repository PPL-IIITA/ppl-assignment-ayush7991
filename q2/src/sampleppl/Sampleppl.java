            ...
            FileHandler fh;  
               ...
               Random rand = new Random();
                 ...
                 //       System.out.println(j);
                     ...
                     //       System.out.println(g[j].boyfriend + " " + " got engaged with " + " " +b[x].girlfriend);
                          //  System.out.println(b[x].girlfriend);
                            ...
                            co[cy]=new couple(b[x].name, g[j].name, b[x].budget, g[j].maintainence_cost,b[x].type,g[j].type,0,0,0,b[x].attractiveness,g[j].attractiveness,b[x].intelligence_level);
                            cy++;
                            //if(cy<15)
                ...
                for(int j=0;j<cy;j++)
                {
                    ...
                    if(co[cy].girltype==2)
                    {
                        co[cy].girlhap=(int)Math.pow(2.7, x);
                    }
